#ifndef DO_SHAKTI_BACKEND_OPENCL_CORE_DEVICE_HPP
#define DO_SHAKTI_BACKEND_OPENCL_CORE_DEVICE_HPP
...
#include <DO/Shakti/Backend/OpenCL/Core/Platform.hpp>
...
namespace DO { namespace Shakti { namespace OpenCL {
                                  ...
                                  cl_device_type device_type = CL_DEVICE_TYPE_ALL)
  {
    ...
    {
      std::cerr
          << format("Error: cannot get number of devices from platform %p! %s",
                    platform.id, get_error_string(err)) << std::endl;
...
#endif /* DO_SHAKTI_BACKEND_OPENCL_CORE_DEVICE_HPP */
